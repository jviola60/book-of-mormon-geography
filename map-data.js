...
const mapLocations = {
  ...
  "city_of_jordan": {
    id: "city_of_jordan",
    name: "City of Jordan",
    title: "Northernmost Nephite Defensive Bastion",
    category: "fortresses",
    region: "Far Land Northward (Near Waters of Ripliancum)",
    coords: { x: 73.8, y: 8.7 },
    highlightSize: "small",
    glowColor: "gold",
    icon: "fort",
    summary: "The northernmost bastion in the Land Northward near the eastern plains and northern waters, where Mormon retreated and successfully repulsed repeated Lamanite assaults during the late wars.",
    refs: [
